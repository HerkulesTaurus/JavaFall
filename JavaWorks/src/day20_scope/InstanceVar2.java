...
public class InstanceVar2 {
	...
	public static void main(String[] args) {
		//instance variable lara main method dan direk ulasýlabýlýr mý? HAYIR 
		//nasýl ulasýlabýlýr? OBJE OLUSTURARAK
		
		InstanceVar2 ali=new InstanceVar2();   //main method icinde degistirilmedigi icin default degerleri alýr 
	...
	public static void staticMethod(){
		//instance variable lara static method dan direk ulasýlabýlýr mý? HAYIR 
		//nasýl ulasýlabýlýr? OBJE OLUSTURARAK
		
	}	
	public static void staticOlmayanMethod(){
		//instance variable lara static olmayan method dan direk ulasýlabýlýr mý? EVET 
		//nasýl ulasýlabýlýr? OBJE OLUSTURARAK
