...
public class C04_PassByValueList {
	...
	public static void main(String[] args) {
		// bir list olusturalim, sonra list elemanlarini degistir method u olusturup
		...
		System.out.println("Main Method da donunce list : " + harfler);

		// Java da list ve Array gibi objeler icin de PassByValue gecerlidir.
