...
System.out.println(tarih.minusYears(5).minusMonths(4).minusDays(18)); //2016-07-15

System.out.println(tarih.minusYears(21).isLeapYear());                //true (artık yıl)
...
System.out.println(dogumTarihi1.isAfter(dogumTarihi2));  //false dogumtarihi1,dogumtarihi2 den sonramı??
