...
public class C02_Maps {
	...
	public static void main(String[] args) {
		...
		// ic ice yapı olusturmak ıcın en ıctekı yapıdan baslamak daha basıc olabılır 
		// ic ice map olusturacaksak en icedekinden baslamanız tavsıye olunur 
		
		
		Map<String, String> ogr1Map = new HashMap<>();
		ogr1Map.put("isim", "Ali");
		ogr1Map.put("soyisim", "Zan");
		...
		System.out.println("1. ogrenci :"+ogr1Map);//1. ogrenci :{soyisim=Zan, brans=J.Dev, isim=Ali}
		System.out.println("2. ogrenci :"+ogr2Map);//2. ogrenci :{soyisim=Yan, brans=QA, isim=Veli}
		System.out.println("3. ogrenci :"+ogr3Map);//3. ogrenci :{soyisim=Yan, brans=C#, isim=Ali}
		System.out.println("4. ogrenci :"+ogr4Map);//4. ogrenci :{soyisim=Can, brans=QA, isim=Ayse}
		...
		/*
		 * {
		 * 101={soyisim=Zan,  brans=J.Dev, isim=Ali}, 
